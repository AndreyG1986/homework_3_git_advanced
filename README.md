...
7. В модуле file_reader.py содержатся две функции:

read_xl_file
Функция для считывания excel файла. Должна принимать путь например: "../data/transactions_excel.xlsx"
А возвращать необходимое колличество словарей в списке. 

read_csv_file
Функция для считывания csv файла. Должна принимать путь например: "../data/transactions.csv"
А возвращать необходимое колличество словарей в списке.